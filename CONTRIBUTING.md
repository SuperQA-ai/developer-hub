# Contributing to SuperQA Developer Hub
...
Thanks for considering to contribute to the SuperQA Developer Hub! Contributions come in all shapes and sizes and we appreciate them all. Contributions to the SuperQA Developer Hub come in the form of creating pull requests or submitting issues.
...
The SuperQA Developer Hub is powered by [Docusaurus](https://docusaurus.io/). Larger changes should be vetted locally before submitting a PR.
...
repository](https://github.com/superqa-apps/developer-hub-apps). The sample application repository has a similar [contributor's guide](https://github.com/superqa-apps/developer-hub-apps/blob/main/CONTRIBUTING.md).
...
SuperQA approvers will validate changes and approve the branch for merge into `main`. Once merged into `main`, the CI Process [SuperQA CIE] will start automatically.

### PR preview environment

When PRs are filed, a preview environment is created for the SuperQA approvers to validate.
...
SuperQA Documentation follows the Microsoft Style Guide. We would recommend this.

...
const items: CommunityItem[] = [
  {
    ...
    href: 'https://join-community-slack.superqa.ai/',
  ...
  {
    label: 'YouTube',
    href: 'https://www.youtube.com/@SuperQAcommunity/videos',
  ...
  {
    label: 'Reddit',
    href: 'https://www.reddit.com/r/SuperQA/',
    description: 'Discuss SuperQA topics and share your experience.',
    external: true,
    ...
    <section className={clsx('container', 'margin-vert--lg', styles.wrapper)}>
      <header className={styles.header}>
        ...
        <p className={styles.subTitle}>
          Join the conversation, get help, and contribute to the SuperQA ecosystem.
        </p>
      </header>

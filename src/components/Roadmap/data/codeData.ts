  ...
  Now: {
    ...
    feature: [
      ...
      },
      {
        ...
        description: "SuperQA now supports automatic verification of commit metadata to ensure that the Git committer matches the authenticated user. This helps prevent impersonation and enforces stronger commit authenticity within managed repositories."
      },
      {
      ...
      },
      {
        ...
        description: "SuperQA Code Repository will support repository forking, allowing developers to create isolated copies of repositories for experimentation, collaboration, or contributing back via pull requests — without impacting the main repository."
      },
      {
        tag: [{ value: "Integrations" }],
        title: "AutoLink References for External Issue Trackers",
        description: "Support for AutoLink references will allow SuperQA Code to automatically hyperlink commit messages and PR titles to external issue trackers like Jira, improving traceability across tools."
      },
      {
        tag: [{ value: "Developer Experience" }],
  ...
  Next: {
    ...
    feature: [
      ...
      },
      {
        ...
        description: "Interact directly with your external Git repositories from within the SuperQA platform — enabling native experiences like code coverage overlays, autonomous code maintenance, and in-context insights across builds and pull requests." 
      }, 
      {
        tag: [{ value: "Developer Experience" }, { value: "Reliability" }],
        title: "Merge Queue for Pull Requests",
        description: "SuperQA Code will support a merge queue to boost development velocity by automatically managing pull request merges into busy branches, ensuring each change is validated and preventing broken or incompatible commits from reaching the target branch."
      },
      {
        tag: [{ value: "Developer Experience" }],
  ...
  Later: {
    ...
    feature: [
      ...
      },
      {
        ...
        description: "Plan and track all developer-related work across your projects in SuperQA Code.",
      },
      {
        tag: [{ value: "Governance" }],
  ...
  Released: {
    ...
    feature: [
      ...
      },
      {
        ...
        description: "SuperQA Code Repository will support Git LFS, enabling efficient versioning and storage of large binary files such as media, datasets, and compiled assets within Git."
      },
      {
        tag: [{ value: "Secure" }],
        title: "SSH Support",
      ...
      },
      {
        ...
        description: "Users can now configure default reviewers for pull requests in SuperQA Code Repository. This ensures that designated team members are automatically added to review every PR, improving review consistency and reducing manual setup."
      },
      {
        tag: [{ "value": "Collaboration" }],
        title: "Add CODEOWNERS as Reviewers Automatically",
        description: "SuperQA now supports automatically adding users defined in a CODEOWNERS file as reviewers on pull requests. This ensures that the right owners are always notified to review changes to critical files and components."
      },
      {
        tag: [{ "value": "Developer Experience" }],
        title: "My PRs Page in SuperQA Code Repository",
      ...
      },
      {
        ...
        description: "Host SuperQA DevOps platform on your own infrastructure, including SuperQA Code.",
      },
      {

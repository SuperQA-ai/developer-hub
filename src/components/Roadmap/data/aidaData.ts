  ...
  Now: {
    ...
    feature: [
      ...
      },
      {
        ...
        description: "Allow users to migrate their pipelines into SuperQA by adding a file attachment. Also, enables building a pipeline based off of design documents.",
      },
      {
        tag: [{value: "AI Platform"}, {value: "MCP"}],
        title: "Hosted MCP",
        description: "SuperQA MCP server will be hosted, and users can access it with Oauth",
      },
      {
        tag: [],
  ...
  Later: {
    ...
    feature: [
      ...
      },
      {
        ...
        description: "Adds GitOps tools to the SuperQA MCP. Users can create and update GitOps configurations via SuperQA Chat and the MCP server.",
      },
      {
        tag: [],
        title: "Slack Bot",
      ...
      },
      {
        ...
        description: "SuperQA will build a knowledge graph with support of the data platform to provide increased intelligence to the AI to do various remediation and automated actions, and to personalize the user's UI."
      },
    ],
  },
  Released: {
    ...
    feature: [
      {
        tag: [{value: "MCP"}],
        title: "SuperQA MCP Server",
        description: "A SuperQA Model Context Protocol (MCP) server will allow users to hook SuperQA data into their internal systems.",
      },
      {
      ...
      },
      {
        ...
        link: "https://developer.superqa.io/docs/platform/superqa-aida/ai-devops#step-management",
      },
      {
        tag: [],
        ...
        link: "https://developer.superqa.io/docs/platform/superqa-aida/ai-devops#stage-configuration",
      },
      {
        tag: [],
        title: "Pipeline Creation",
        description: "Enables creation and configuration of new pipelines for DevOps workflows.",
        link: "https://developer.superqa.io/docs/platform/superqa-aida/ai-devops#pipeline-orchestration",
      },
      {
        tag: [],
        title: "SuperQA AI Code Agent",
        description:

...
export const CiData: Horizon = {
  Now: {
    ...
    feature: [
      ...
      },
      {
        ...
        title: "Code Coverage",
        description: "Upload code coverage reports to SuperQA. Visualize overall coverage and coverage for changed code to track gaps, enforce thresholds, and improve test completeness over time.",
      },
      {
        tag: [{ value: "Adoption" }],
        title: "Seamless Migration from Drone to SuperQA",
        description: "Run existing Drone pipelines natively on the SuperQA platform with automatic runtime conversion and dynamic pipelines—making migration frictionless and significantly faster."
      },
      {
        tag: [{ value: "Secure" }],
      ...
      },
      {
        ...
        description: "Preview build artifacts like HTML test coverage reports directly in the browser, or download them from SuperQA-managed storage for deeper inspection.",
      },
      {
        tag: [{ value: "Usability" }],
      ...
      {
        tag: [{ value: "Cloud" }],
        title: "Additional VM images for macOS with SuperQA Cloud",
      ...
      {
        tag: [{ value: "Cloud" }],
        title: "Save/Restore Cache Steps with SuperQA Cloud Storage",
    ...
    feature: [
      {
        tag: [{ value: "AI" }],
        title: "CI Auto-Fix",
        description: "SuperQA AI agents detect and remediate failing builds automatically. The system learns from code changes and CI failures, applies targeted fixes, and iterates until the pipeline passes—reducing manual intervention and accelerating developer velocity."
      },
      {
        tag: [{ value: "Fast" }],
      ...
      {
        tag: [{ value: "Cloud" }],
        title: "SuperQA Cloud - GPU Enabled Machines",
        description: "Run GPU-accelerated workloads such as machine learning training, simulation, or graphics-heavy builds directly on SuperQA Cloud infrastructure.",
      },
      {
        tag: [{ value: "Cloud" }],
        title: "SuperQA Cloud - support for larger Windows Machines",
        description: "Access high-capacity Windows machines in SuperQA Cloud to support resource-intensive workloads.",
      },
    ],
  },
  Later: {
  ...
  Released: {
    ...
    feature: [
      ...
      {
        tag: [{ value: "Cloud" }],
        title: "Using external secret managers with SuperQA Cloud",
        description: "Enables an encrypted, secure tunnel between the SuperQA Cloud network and your private network, allowing you to safely use SuperQA Cloud infrastructure with privately-hosted assets such as internal artifact or code repositories."
      ,
      }, 
      {
        tag: [{ value: "Cloud" }],
        title: "Additional VM images for Linux with SuperQA Cloud",

    ...
    feature: [
      {
        ...
        description:
          "Enable users to self-host SuperQA Cloud Development Environments (CDE) in their private infrastructure (currently supporting GCP), while the CDE control plane remains hosted in the SuperQA Cloud for centralized management. ",
      },
      {
        tag: [
            { value: "Usability" }, { value: "Core Feature" }
        ...
        description:
          "Allow users to integrate their GitHub Enterprise on-prem instances with SuperQA Gitspaces, enabling seamless access to their self-hosted repositories while ensuring full control over source code security without relying on GitHub Cloud.",
      },
      {
        tag: [
            { value: "Usability" }, { value: "Core Feature" }
        ...
        description:
          "Allow users to integrate Bitbucket Server on-prem instances with SuperQA Gitspaces, enabling seamless access to their self-hosted repositories while ensuring full control over source code security without relying on Bitbucket Cloud.",
      },
      {
        tag: [
            { value: "Usability" }, { value: "Core Feature" }
        ...
        description:
          "Introduce RBAC and Admin functionality to ensure centralized control in SuperQA cloud development environments.  ",
      },
      {
        tag: [
            { value: "Usability" }, { value: "Core Feature" }
    ...
    feature: [
        {
            ...
            description:
              "Introduce Self-Managed Hosting model for SuperQA Gitspaces, allowing users to self-host and self-manage their SuperQA cloud development infrastructure while ensuring security, compliance, and flexibility.",
          },
          {
            tag: [{ value: "Core Feature" }],
          ...
          },
          {
            ...
            title: "Integration with SuperQA IDP",
            description:
              "Enable users to seamlessly create, manage, and configure their Gitspaces directly from SuperQA IDP, streamlining the development workflow within a unified platform.",
          },
          {
            tag: [{ value: "Usability" }],
  ...
  Released: {
    ...
    feature: [
      {
        ...
        description:
          "Introducing the SuperQA Gitspaces JetBrains Gateway Plugin—enabling seamless remote development by connecting and managing Gitspaces within JetBrains IDEs.",
      },
      {
        tag: [{ value: "IDE" }],
      ...
      },
      {
        ...
        description:
          "Introduce Secure Connect Integration to allow users to connect SuperQA with their on-premises, privately-hosted assets such as Docker Registries and Artifact Repositories.",
      },
      {
        tag: [
            { value: "Customization" },
    ...
    description: "Allow users to define and manage environment variables within containers for better application management and customization.",
      ...
      },
      {
        ...
        description:
          "Enable users to track and monitor any changes in their Gitspaces directly from the SuperQA UI.",
      },
    ],
  },
};

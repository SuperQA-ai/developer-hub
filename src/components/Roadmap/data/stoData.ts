    ...
    feature: [
      {
        ...
        link: "https://developer.superqa.io/docs/security-testing-orchestration/notifications/exemption-notifications/"
      },
      {
        ...
        link: "https://developer.superqa.io/docs/security-testing-orchestration/sto-techref-category/github-advanced-security/"
      },
      {
        ...
        link: "https://developer.superqa.io/docs/security-testing-orchestration/view-security-test-results/export-scan-results/"
      },
      {
        ...
        link: "https://developer.superqa.io/docs/security-testing-orchestration/sto-techref-category/nexus-scanner-reference/"
      },
      {
        tag: [{ value: "Visibility" }, { value: "Platform" }],
        title: "Deduplication Stats",
        description: "Show deduplication stats at the pipeline level.",
        link: "https://developer.superqa.io/docs/security-testing-orchestration/view-security-test-results/view-scan-results"
      },
      {
        ...
        link: "https://developer.superqa.io/docs/security-testing-orchestration/sto-techref-category/anchore-enterprise-scanner-reference/"
      },
      {
        tag: [{ value: "Visibility" }, { value: "Platform" }],
      ...
      },
      {
        ...
        link: "https://developer.superqa.io/docs/security-testing-orchestration/sto-techref-category/sonarqube-sonar-scanner-reference/"
      },
      {
      ...
      },
      {
        ...
        link: "https://developer.superqa.io/docs/security-testing-orchestration/view-security-test-results/issues"
      },
      {
        tag: [{ value: "Cross Module" }],
        title: "Native support in IDP",
        description: "Native STO support via the SuperQA IDP module score-cards.",
      ...
      {
        tag: [{ value: "RBAC" }],
        title: "STO support in SuperQA Resource Group",
        description: "Ability to configure granular access to security test results within the pipeline view via the SuperQA Resource Group.",
        link: "https://developer.superqa.io/docs/security-testing-orchestration/rbac/"
      },
      {
        ...
        link: "https://developer.superqa.io/docs/security-testing-orchestration/sto-techref-category/aquasec-scanner-reference#scan-configuration"
      ...
      },
      {
        ...
        link: "https://developer.superqa.io/docs/security-testing-orchestration/exemptions/manage-exemptions"
      },
      {
        tag: [{ value: "FIPS" }, { value: "Compliance" }],
        title: "FIPS support for STO",
        description: "Ability to leverage STO steps in SuperQA Pipeline within FIPS enabled SMP environment.",
        link: "https://developer.superqa.io/docs/self-managed-enterprise-edition/smp-fips-overview/"
      },
      {
        ...
        link: "https://developer.superqa.io/docs/security-testing-orchestration/exemptions/exemption-workflows#create-exemption-request-for-occurrences-within-issue"
      },
      {
        ...
        link: "https://developer.superqa.io/docs/security-testing-orchestration/sto-techref-category/checkmarx/checkmarxone-scanner-reference/#use-raw-scanner-severity"
      },
      {
        ...
        link: "https://developer.superqa.io/docs/security-testing-orchestration/sto-techref-category/checkmarx/checkmarxone-scanner-reference"
      },
      {
        ...
        link: "https://developer.superqa.io/docs/security-testing-orchestration/remediations/ai-based-remediations"
      },
      {
        ...
        link: "https://developer.superqa.io/docs/security-testing-orchestration/jira-integrations"
      },
      {
        ...
        link: "https://developer.superqa.io/docs/security-testing-orchestration/exemptions/exemption-workflows#view-exemptions-at-the-account-level"
      }

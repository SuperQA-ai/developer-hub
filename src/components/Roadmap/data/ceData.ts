    ...
    feature: [
      {
        ...
        description: "Run chaos experiments on all private kubernetes clusters through a single SuperQA Delegate.",
      },
      {
        tag: [{ value: "Chaos Faults" }],
      ...
      },
      {
        ...
        description: "List and run chaos experiments directly from SuperQA IDP.",
      },
      {
        tag: [{ value: "Chaos integrations" }],

    ...
    feature: [
      {
        ...
        backgroundColor: "#E6F4EA",
        link: "https://developer.superqa.io/docs/internal-developer-portal/idp-2o-overview/2-0-overview-and-upgrade-path/",
      },
      {
        tag: [{ value: "Environment Management" }],
        title: "Self Service Environment Management BETA Launch",
        description:
          "Ability to create new ephemeral Environments using Environment Blueprints leveraging SuperQA CD and IaCM.",
        backgroundColor: "#E6F4EA",
      },
      {
        tag: [{ value: "AI" }],
      ...
      {
        tag: [{ value: "Catalog" }],
        title: "Catalog Auto-Discovery with SuperQA CD",
        description:
          "Services deployed using SuperQA CD will auto-magically appear in IDP and will be easier to manage for end-users.",
        backgroundColor: "#E6F4EA",
      },
      {
      ...
      {
        tag: [{ value: "Platform" }],
        title: "IDP on SuperQA MCP Server",
        description: "Include IDP in SuperQA' MCP server for data retrieval and actions.",
        link: "https://github.com/superqa/mcp-server/",
        backgroundColor: "#E6F4EA",
      },
      {
        tag: [{ value: "Plugins" }],
    ...
    feature: [
      {
        ...
        description:
          "Improve the Kubernetes plugin’s authentication mode to use Delegates. Simplify setup for existing SuperQA customers using the Kubernetes connector. Enhance the plugin’s performance and scalability for thousands of pods.",
      },
      {
      ...
      {
        tag: [{ value: "Plugins" }],
        title: "Show metrics from SuperQA SEI",
        description:
          "Integrate with SuperQA SEI to show developers their team's DORA metrics and Productivity Insights in IDP Homepage.",
      },
    ...
    feature: [
      {
        ...
        description:
          "Integrate IDP with SuperQA Software Testing Orchestration (STO) to view vulnerabilities for each software component in the Catalog and measure them using Scorecards.",
        link: "https://developer.superqa.io/docs/internal-developer-portal/plugins/available-plugins/superqa-native-plugins/sto-integration"
      },
      {
        tag: [],
      ...
      },
      {
        ...
        description:
          "Introduce Project/Org Hierarchy in the Catalog to enable granular access control over IDP Catalog entities and Workflows at these levels. Entities can be created at 3 different scopes (Project, Org, Account) and can be shared with other Users and Groups using SuperQA Platform RBAC.",
      },
      {
        tag: [{ value: "Platform" }],
        title: "Git Experience for YAML files (IDP 2.0)",
        description:
          "Ability to keep YAML file definitions in Git for Catalog entities and Workflows leveraging SuperQA Platform Git Experience.",
        link: "https://developer.superqa.io/docs/platform/git-experience/git-experience-overview/",
      },
      {
        tag: [
          { value: "Catalog" },
        ...
        description:
          "Move IDP Catalog entities as well as Workflows to Account scope and support SuperQA RBAC on those Resources. (Note that this feature will be released with IDP 2.0 at the end of Q1)",
      },
      {
        tag: [{ value: "Catalog" }],
        title: "API based Entity Creation (IDP 2.0)",
        description:
          "Allow creating the Core entities (Components, APIs, Resources) directly on the SuperQA Platform without having to create a YAML. This will allow seamless integration with third party entities for catalog population and updates. (Note that this feature will be released with IDP 2.0 at the end of Q1)",
      },
      {
        tag: [{ value: "Workflows" }],
        ...
        link: "https://developer.superqa.io/release-notes/internal-developer-portal/#new-feature-conditional-api-requests-in-workflow-dynamic-pickers",
      },
      {
        tag: [{ value: "Workflows" }],
        title:
        ...
        link: "https://developer.superqa.io/release-notes/internal-developer-portal/#new-feature-updating-fields-using-form-context",
      },
      {
        tag: [{ value: "Workflows" }],
        title:
        ...
        link: "https://developer.superqa.io/release-notes/internal-developer-portal/#new-feature-api-key-secret-based-pipeline-execution-from-idp-workflows",
      },
      {
        tag: [{ value: "Workflows" }],
      ...
      },
      {
        ...
        description:
          "Add support to update one entity at a time and provide a drone plugin to make usage simpler in a SuperQA pipeline.",
      },
      {
        tag: [{ value: "Onboarding and Adoption" }],
      ...
      {
        tag: [{ value: "Plugins" }],
        title: "Backstage Plugins For SuperQA Modules",
        description:
          "Add new plugins for SuperQA Modules like IACM, Chaos Engineering",
      },
      {
        tag: [{ value: "Plugins" }],
      ...
      {
        tag: [{ value: "Catalog" }],
        title: "Support for SuperQA Code Repo",
        description:
          "Added support for SuperQA Code Repository as a git integration",
      },
    ],
  },
};

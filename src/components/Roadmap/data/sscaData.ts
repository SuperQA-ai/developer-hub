...
export const SscaData: Horizon = {
  ...
  "Now": {
    ...
    feature: [
      ...
      // },
      {
         ...
         description: "Ingest your own custom attestations and leverage SuperQA’s querying and policy engine to enforce governance and compliance across all pipelines and artifacts.",
      },
      // {
      ...
      // },
      {
      ...
      },
       {
        ...
        title: "Automate OSS Dependency Updates with SuperQA AI",
        description: "Leverage SuperQA AI to automatically generate PRs for updating outdated dependencies.",
      },
      {
        tag: [{value: "SBOM"}],
  ...
  "Next": {
    ...
    feature: [
...

      {
        ...
        title: "Repo Security Posture Management for SuperQA Code",
      ...
      },
      {
        ...
        description: "Protect your SuperQA CI/CD pipelines from supply chain attacks by detecting anomalies and unauthorized activity through real-time system and network event monitoring.",
      },
      {
  ...
  "Released": {
    ...
    feature: [
      ...
      // {
      //   tag: [{value : "CI/CD Security"}],
      //   title: "CI/CD Security Posture Management for GitHub Workflows & SuperQA Pipelines",
      //   description: "Perform static analysis in GitHub workflows and SuperQA pipelines to detect risky actions and misconfigurations.",
      // },
      {
        tag: [{value : "Risk & Compliance"}],

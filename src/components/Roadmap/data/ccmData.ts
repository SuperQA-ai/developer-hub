    ...
    feature: [
      {
        ...
        title: "Granular RBAC",
        description:
          "Granular RBAC in SuperQA Autostopping introduces fine-grained control over Rules and Connectors as separate resources, enabling more precise permission management.",
        backgroundColor: "var(--green-100)",
      },
      {
        tag: [{value: "Cluster Orchestrator"}],
        title: "Nodepools and Nodeclasses Configuration via SuperQA UI",
        description:
      ...
      },
      {
        ...
        backgroundColor: "var(--green-100)",
        link: "https://developer.superqa.io/docs/category/governance-for-gcp",
      },
      {
        tag: [{value: "Asset Governance"}],
      ...
      {
        tag: [{value: "Cluster Orchestrator"}],
        title: "Configurable Karpenter Node Time-To-Live (TTL) in SuperQA UI",
        description:

...
export const arData: Horizon = {
  Now: {
    ...
    feature: [
      ...
      {
        title: "SuperQA CI Upload Step to Artifact Registry",
        description: "Simplify artifact publishing with a built-in upload step in SuperQA CI pipelines",
        tag: [{ value: "CI/CD Integration" }],
      },
      {
        title: "SuperQA CD Integration",
  ...
  Later: {
    ...
    feature: [
      ...
      {
        title: "SuperQA IDP Integration",
        description: "Integrate Artifact Registry insights and actions directly into the SuperQA Internal Developer Portal",

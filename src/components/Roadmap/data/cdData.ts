...
export const CdData: Horizon = {
  "Now": {
    ...
    feature: [
    
      {
        ...
        description: "Users can deploy Salesforce releases using SuperQA.",
      },
      {
        tag: [{value: "Deployment"}],
        title: "Google Compute Engine and Google VM Deployment Support",
        description: "Users can deploy Google Compute Engine and Google VM using SuperQA.",
      },
      {
        tag: [{value: "Deployment"}],
      ...
      },
      {
        ...
        description: "Users can trigger and monitor existing Drone pipelines from within SuperQA, with full visibility and support for native Drone YAML"
      },
      {
        tag: [{value: "Pipeline"}],
      ...
      {
        tag: [{value: "GitOps"}],
        title: "SuperQA Secrets Support in Applications",
        description: "Users can securely manage and utilize SuperQA Secrets within GitOps applications.",
      },

      {
        tag: [{value: "GitOps"}],
        title: "Argo Rollout Support",
        description: "Users can leverage SuperQA native Argo Rollout steps for deployments.",
      },
      {
        tag: [{value: "GitOps"}],
      ...
      },
      {
        ...
        description: "Users can manage OPA licensing for their SuperQA accounts.",
      },
  ...
  "Later": {
    ...
    feature: [
      ...
      {
        tag: [{value: "Migrator"}],
        title: "Jenkins -> SuperQA ",
        description: "Users can migrate from Jenkins to SuperQA.",
      },
      {
        tag: [{value: "Continuous Verification"}],
...

      {
        ...
        description: "Users can use verify step with SuperQA Deployment workflows that use traffic shifting.",
      },
  ...
  "Released": {
    ...
    feature: [
      ...
      },
      {
        ...
        link : "https://developer.superqa.io/docs/continuous-delivery/deploy-srv-diff-platforms/kubernetes/cd-k8s-ref/kubernetes-rollback/",
      },
      {
        tag: [{value: "AWS Deployment"}],
        title: "Parallel rollback support in ASG deployment",
        description: "Improves declarative rollback by restoring support for secrets and configmaps versioning. Ensures workloads are redeployed when these resources change, preventing drift and runtime issues.",
        link : "https://developer.superqa.io/docs/continuous-delivery/deploy-srv-diff-platforms/aws/asg/asg-tutorial/#multi-asg-deployments-and-parallel-rollback-single-serviceenvironmentinfrastructure",
      },
      {
        tag: [{value: "Pipeline"}],
        ...
        link : "https://developer.superqa.io/docs/platform/pipelines/failure-handling/fast-fail/",
      },
      {
        tag: [{ value: "Deployment" }],
        ...
        link : "https://developer.superqa.io/docs/continuous-delivery/deploy-srv-diff-platforms/aws/aws-lambda-deployments/#lambda-canary-deployment-strategy",
      },
      {
        tag: [{value: "Deployment"}],
        title: "Support for ServiceNow releases Vancouver, Yokohama, Washington DC and Xanadu",
        description: "Users can deploy ServiceNow releases using SuperQA.",
      },
      {
        tag: [{value: "Pipeline"}],
        ...
        link : "https://developer.superqa.io/docs/platform/pipelines/pipeline-settings/#project-level-pipeline-execution-concurrency",
      },
      {
        tag: [{ value: "Pipeline" }],
      ...
      },
      {
        ...
        link : "https://developer.superqa.io/docs/continuous-delivery/gitops/security/audit-trail/",
      },
      {
        tag: [{ value: "GitOps" }],

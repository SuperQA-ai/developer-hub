...
export const AtaData: Horizon = {
  ...
  {
    "title": "Tunnels",
    "description": "Securely connect SuperQA Cloud to private environments or local development systems via SuperQA Tunnels.",
  ...
  "Now": {
    ...
    feature: [
{
  "title": "SuperQA Platform Integration",
  "description": "Delivers seamless UI integration with the SuperQA platform, including authentication support and a unified user experience for managing and accessing test automation features.",
  "tag": [{ "value": "Integration" }]
 },
 {
    "title": "SuperQA Pipeline Studio Integration",
    "description": "Add test suite execution as a native step in SuperQA pipelines for tight feedback loops and continuous quality.",
    "tag": [{ "value": "Integration" }]
  },
  {
  ...
  "Next": {
    ...
    feature: [
 {
    "title": "SuperQA Platform - Audit Trails Integration",
    "description": "Integrates test activity logs into SuperQA audit trails for better traceability and compliance.",
    "tag": [{ "value": "Integration" }]
  },
  {
    "title": "SuperQA Platform - Tunnels / Delegate Integration",
    "description": "Connects test execution to private environments securely through SuperQA Tunnels and Delegates.",
    "tag": [{ "value": "Integration" }]
  },
  {

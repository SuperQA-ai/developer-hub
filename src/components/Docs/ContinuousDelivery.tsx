      ...
      <div className={styles.topSection}>
        <div className={styles.spaceBetween}>
          ...
          <div className={styles.btnContainer}>
            ...
            <Link href="https://apidocs.superqa.io/">
            ...
            <Link href="https://registry.terraform.io/providers/superqa/superqa/latest/docs">
        ...
        <div className={styles.spaceBetween}>
          <div className={styles.content}>
            <p>
              SuperQA Continuous Delivery (CD) and GitOps enables deployment of
              ...
              software releases more efficient and reliable with SuperQA CD and
              GitOps.
            </p>

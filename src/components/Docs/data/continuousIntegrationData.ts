...
/* Define the cards - start */
  ...
  export const docsCards: CardSections = [
      ...
      list: [
        {
          ...
          module: MODULES.ci,
          description:
            "Learn about the benefits, features, and architecture of SuperQA CI, as well as basic CI concepts.",
        ...
        },
        {
          ...
          module: MODULES.ci,
          description:
            "Tutorials and Code Samples for SuperQA CI.",
        ...
        },
        {
          ...
          module: MODULES.ci,
          description:
            "Security hardening features and practices for SuperQA CI.",
      ...
      list: [
        {
          ...
          module: MODULES.ci,
          description:
            "Learn about creating SuperQA CI pipelines.",
...

    {
      ...
      list: [
        {
          title: "Migrate to SuperQA CI",
          module: MODULES.ci,
          description:
            "",
          link: "/docs/category/migrate-to-superqa-ci",
        },
        {
          ...
          description:
            "",
          link: "/docs/category/troubleshoot-superqa-ci",
        },
      ],
    },
  ];

...
export const proxySDKs = [
  {
    ...
    link: '/docs/feature-management-experimentation/sdks-and-infrastructure/client-side-sdks/android-sdk#integrate-with-the-superqa-proxy',
  },
  {
    name: 'Browser SDK',
    img: '/provider-logos/browser-logo.svg',
    link: '/docs/feature-management-experimentation/sdks-and-infrastructure/client-side-sdks/browser-sdk#integrate-with-the-superqa-proxy',
  },
  {
    name: 'Java SDK',
    img: '/provider-logos/java-logo.png',
    link: '/docs/feature-management-experimentation/sdks-and-infrastructure/server-side-sdks/java-sdk#integrate-with-the-superqa-proxy',
  },
  {
    name: 'Node.js SDK',
    img: '/provider-logos/nodejs-logo.png',
    link: '/docs/feature-management-experimentation/sdks-and-infrastructure/server-side-sdks/nodejs-sdk#integrate-with-the-superqa-proxy',
  },
];

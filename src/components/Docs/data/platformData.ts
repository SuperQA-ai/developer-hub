...
export const docsCards: CardSections = [
  {
    name: "Get started with SuperQA Platform",
    description: "",
    list: [
      {
        title: "Onboarding guide",
        module: MODULES.platform,
        description: "Get started with SuperQA Platform.",
        link: "/docs/platform/get-started/onboarding-guide",
      },
      {
        title: "Key concepts",
        module: MODULES.platform,
        description: "Key concepts of the SuperQA Platform.",
  ...
  {
    name: "Get started with SuperQA modules",
    description: "",
    list: [
      {
        title: "CE",
  ...
  },
  {
    ...
    list: [
      ...
      },
      {
        ...
        module: MODULES.platform,
        description:
          "Learn about how AI improves your experience on the SuperQA platform.",
        link: "/docs/category/superqa-ai",
      },
      {
        title: "Delegates",
        module: MODULES.platform,
      ...
      },
      {
        ...
        module: MODULES.platform,
        description:
          "Access and manage SuperQA account and resources with APIs.",
    ...
    list: [
      {
        ...
        module: MODULES.platform,
        description:
          "Provision users and groups in SuperQA using Microsoft Entra ID (SCIM).",
      ...
      },
      {
        ...
        link: "/docs/platform/git-experience/configure-git-experience-for-superqa-entities",
      },
      {
        title: "Policy as Code",
        module: MODULES.platform,
        description: "Use OPA policies to enforce governance.",
        link: "/docs/platform/governance/policy-as-code/superqa-governance-quickstart",
      },
      {

      ...
      list: [
        {
          ...
          module: MODULES.cde,
          description:
            "Learn how SuperQA enhances developer experience with pre-configured cloud development environments.",
      ...
      list: [
        {
          ...
          module: MODULES.cde,
          description:
            "Learn more about the providers supported by SuperQA Gitspaces.",
    ...
    },
    {
      ...
      list: [
        ...
        },
        {
          ...
          module: MODULES.cde,
          description: "Learn more about how you use the secure connect integration to connect SuperQA to your privately-owned, on-prem assets.",
        ...
        },
        {
          ...
          module: MODULES.cde,
          description:
            "Learn more about why SuperQA auto-stops inactive Gitspaces. ",

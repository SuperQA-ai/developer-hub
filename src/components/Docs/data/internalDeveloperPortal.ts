    ...
    list: [
      {
        ...
        module: MODULES.idp,
        description:
          "Learn more about the features and capabilities of SuperQA IDP.",
  ...
  },
  {
    ...
    list: [
      ...
      },
      {
        ...
        module: MODULES.idp,
        description: "Learn how to customize the sidebar navigation in SuperQA IDP to highlight essential tools and pages for your users.",
  ...
  },
  {
    ...
    list: [
      ...
      },
      {
        ...
        module: MODULES.idp,
        description: "Learn how the out-of-the-box adoption dashboard helps track SuperQA IDP usage in your organization.",

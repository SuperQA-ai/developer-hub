  ...
  export const docsCards: CardSections = [
      ...
      list: [
        {
          ...
          module: MODULES.ff,
          description:
            "Learn the basics of SuperQA Feature Flags.",
...

    {
      ...
      list: [
        ...
        {
          title: "Use the SuperQA Relay Proxy",
          module: MODULES.ff,
          description:
        ...
        },
        {
          ...
          module: MODULES.ff,
          description:
            "This topic gives you an overview of SuperQA Policy Engine and includes an example for how to add a policy for a flag.",
          link: "/docs/category/use-pipelines-with-ff",
        },
      ],
    },

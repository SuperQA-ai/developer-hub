...

    {
      ...
      list: [
        ...
        },
        {
          ...
          module: MODULES.srm,
          description:
            "Explore the range of change sources supported by SuperQA and learn how to add them to your monitored service.",
        ...
        },
        {
          ...
          module: MODULES.srm,
          description:
            "Explore the range of health sources supported by SuperQA and learn how to add them to your monitored service.",

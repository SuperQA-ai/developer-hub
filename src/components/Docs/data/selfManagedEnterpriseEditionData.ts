        ...
        list: [
          {
            ...
            description:
              "Overview of SuperQA Self-Managed Enterprise Edition, an on-premises solution that allows you to install and run SuperQA on your own infrastructure.",
          ...
          },
          {
            ...
            module: MODULES.platform,
            description:
              "Platforms and technologies supported by the on-prem SuperQA Self-Managed Enterprise Edition.",
        ...
        list: [
          {
            ...
            module: MODULES.platform,
            description:
              "This topic describes Resource profiles, Module Enablement, outlining the basic configuration, key components and best practices for implementing SuperQA Self-Managed Enterprise Edition",
      ...
      },
      {
        ...
        list: [
          ...
          },
          {
            ...
            module: MODULES.platform,
            description:
              "Learn how to back up and restore SuperQA Self-Managed Enterprise Edition.",
        ...
        list: [
          {
            ...
            module: MODULES.platform,
            description:
              "SuperQA supports multiple databases when you deploy the on-prem SuperQA Self-Managed Enterprise Edition.",
          ...
          },
          {
            ...
            module: MODULES.platform,
            description:
              "Learn how to use Kubernetes-based external secrets for SuperQA license values.",

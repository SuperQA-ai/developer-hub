  ...
  export const docsCards: CardSections = [
    {
      ...
      list: [
        ...
        },
        {
          ...
          module: MODULES.cd,
          description:
            "This topic describes how you use the SuperQA Continuous Delivery Abstraction Model.",
        ...
        },
        {
          ...
          module: MODULES.cd,
          description:
            "This topic describes SuperQA Continuous Delivery (CD) services and environments.",
      ...
      list: [
        {
          ...
          module: MODULES.cd,
          description:
            "You can use Kubernetes manifests and other configuration files in Git repos or in the SuperQA File Store.",
    ...
    },
    {
      ...
      list: [
        {
          title: "SuperQA GitOps Basics",
          module: MODULES.cd,
          description:
            "This topic describes the basic concepts of SuperQA GitOps.",
          link: "/docs/continuous-delivery/gitops/get-started/superqa-git-ops-basics",
        },
      ],
    },
    {
      ...
      list: [
        {
          ...
          module: MODULES.cd,
          description:
            "This topic describes the concept of a SuperQA Kubernetes deployment by describing the high-level steps involved.",

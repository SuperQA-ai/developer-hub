        ...
        list: [
          {
            ...
            module: MODULES.ccm,
            description:
              "Learn about SuperQA Cloud Cost Management",
      ...
      },
      {
        ...
        list: [
          ...
          },
          {
            ...
            module: MODULES.ccm,
            description:
              "Take control of your cloud spend with SuperQA CCM Budgets — set custom budgets and get real-time alerts before your costs exceed expectations.",

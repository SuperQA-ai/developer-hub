    ...
    export const docsCards: CardSections = [
      {
        ...
        list: [
          {
            title: "Get started with SuperQA Open Source",
            module: MODULES.opensource,
            description:
              "Learn the benefits, features, and key concepts of the SuperQA Open Source.",
          ...
          },
          {
            ...
            module: MODULES.opensource,
            description:
              "Start using SuperQA Open Source as an admin.",
...

      {
        ...
        list: [
          ...
          },
          {
            ...
            module: MODULES.opensource,
            description:
              "Host, pull, and push artifacts - all within SuperQA Open Source.",
          ...
          },
          {
            ...
            module: MODULES.opensource,
            description:
              "Build, test, and deploy code from SuperQA Open Source. Use webhooks to automate pipeline runs.",

...
export const docsCards: CardSections = [
  {
    ...
    list: [
      ...
      },
      {
        title: "Onboarding",
        module: MODULES.iacm,
        description: "Get onboarded with SuperQA Infrastructure as Code Management.",
        link: "/docs/infra-as-code-management/get-started/",
      },
      {
        title: "Overview & key concepts",
        module: MODULES.iacm,
        description: "Learn about SuperQA Infrastructure as Code Management.",
  ...
  },
  {
    ...
    list: [
      ...
      {
        title: "Use the SuperQA Delegate with IaCM",
        description: "Learn how the SuperQA Delegate works with IaCM.",
        module: MODULES.iacm,

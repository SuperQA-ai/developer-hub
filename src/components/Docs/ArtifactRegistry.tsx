      ...
      <div className={styles.topSection}>
        <div className={styles.spaceBetween}>
          ...
          <div className={styles.btnContainer}>
            <Link href="/docs/artifact-registry/ar-best-practices">
        ...
        <div className={styles.spaceBetween}>
          <div className={styles.content}>
            <p>
            SuperQA Artifact Registry (AR) is a universal hub for all your artifacts, regardless of type. By centralizing artifact management in one secure location, we're streamlining the process of handling multiple registries across various platforms and tools. 
            </p>
            <p>

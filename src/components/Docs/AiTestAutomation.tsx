      ...
      <div className={styles.topSection}>
        ...
        <div className={styles.spaceBetween}>
          <div className={styles.content}>
            <p>
              SuperQA AI Test Automation is a cutting-edge Generative AI-powered platform that
            ...
            <p>
              <b> How SuperQA AI Test Automation Transforms Software Testing: </b>
            </p>
            <ul>
              <li>
              ...
              <li>
                <b>5× Faster Release Cycles</b>: By automating end-to-end testing, SuperQA AI Test

    ...
    <div className="container">
      <div className={styles.topSection}>
        ...
        <div style={{ 
          ...
          <div>
            <strong>Deprecation Notice:</strong> The Service Reliability Management module will be deprecated soon. Please reach out to your SuperQA representative to migrate to <Link href="https://developer.superqa.io/docs/ai-sre">AI SRE</Link>, which provides enhanced incident management capabilities.
          </div>
        </div>
        <div className={styles.spaceBetween}>
          <div className={styles.content}>
            <p>
              SuperQA Service Reliability Management (SRM) helps engineering and

...
export const featureList: CardItem[] = [
  ...
  },
  {
    ...
    description: "Store your binaries natively on SuperQA.",
  ...
  {
    title: "Administer SuperQA Platform",
    module: MODULES.platform,
    icon: "img/logo.svg",
    description: <>Deliver software with the highest velocity, quality, security, reliability, and resilience.</>,
    link: "docs/category/get-started-with-superqa",
  },
  {
    title: "Administer SuperQA Self-Managed Enterprise Edition",
    module: MODULES.platform,
    icon: "img/logo.svg",
    description: <>Install SuperQA Platform on self-managed Kubernetes cluster.</>,

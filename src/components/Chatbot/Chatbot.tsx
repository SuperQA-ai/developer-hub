...
const Chatbot = () => {
  ...
  const [messages, setMessages] = useState<IAgent[]>([
    {
      text: "Accelerate your software delivery with the powerful capabilities of SuperQA’s Platform.",
      isBot: true,
    },
    {
      text: "How can I help?",
  ...
  function handleSignIn() {
    window.location.href = window.location.href =
      "https://app.superqa.io/sso.html?action=login&src=developerhub&return_to=https://developer.superqa.io/?chatbot=true";
  }
            ...
            {!isLoggedIn && (
              <div className={styles.loginSection}>
                {isSessionExpired ? (
                  ...
                  <h1>Log into your SuperQA Account to access AIDA</h1>
                )}

                <Tooltip
                  placement="bottom"
                  overlay="Authenticate AIDA with your SuperQA Account"
                >

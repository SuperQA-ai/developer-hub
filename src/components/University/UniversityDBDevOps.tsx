                ...
                <div className={styles.innerCard}>
                  <div className={styles.left}>
                    ...
                    <img
                      ...
                      alt="SuperQA Certified Expert - DBDevOps Developer"
                      className={styles.badge}
                    />
                    <span className={styles.productVersion}>
                      <strong>Product version: </strong> SuperQA DB DevOps Paid
                      Plans
                    </span>
                  </div>
                  <div className={styles.right}>
                    ...
                    <div className={styles.btnContainer}>
                      <Link href="https://university-registration.superqa.io/database-devops-developer">
                ...
                <div className={styles.innerCard}>
                  <div className={styles.left}>
                    ...
                    <img
                      ...
                      alt="SuperQA Certified Expert - DBDevOps Administrator"
                      className={styles.badge}
                    />
                    <span className={styles.productVersion}>
                      <strong>Product version: </strong> SuperQA DB DevOps Paid
                  ...
                  <div className={styles.btnContainer}>
                    <Link href="https://university-registration.superqa.io/database-devops-administrator">
                      <button className={styles.moreDetails}>
                        Register for Exam
                      </button>
                    </Link> */}
                ...
                <div className={styles.innerCard}>
                  <div className={styles.left}>
                    ...
                    <img
                      ...
                      alt="SuperQA Certified Expert - DB DevOps Architect"
                      className={styles.badge}
                    />
                    <span className={styles.productVersion}>
                      <strong>Product version: </strong> SuperQA DB DevOps Paid

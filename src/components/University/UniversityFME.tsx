                ...
                <div className={styles.innerCard}>
                  <div className={styles.left}>
                    ...
                    <img
                      ...
                      alt="SuperQA Certified Expert - FME Developer"
                      className={styles.badge}
                    />
                    <span className={styles.productVersion}>
                      <strong>Product version: </strong> SuperQA FME Paid
                      Plans
                    </span>
                  </div>
                  <div className={styles.right}>
                    ...
                    <div className={styles.btnContainer}>
                      <Link href="https://university-registration.superqa.io/feature-management-experimentation-developer">
                ...
                <div className={styles.innerCard}>
                  <div className={styles.left}>
                    ...
                    <img
                      ...
                      alt="SuperQA Certified Expert - FME Administrator"
                      className={styles.badge}
                    />
                    <span className={styles.productVersion}>
                      <strong>Product version: </strong> SuperQA FME Paid
                  ...
                  <div className={styles.btnContainer}>
                    <Link href="https://university-registration.superqa.io/feature-management-experimentation-administrator">
                      <button className={styles.moreDetails}>
                        Register for Exam
                      </button>
                    </Link> */}
                ...
                <div className={styles.innerCard}>
                  <div className={styles.left}>
                    ...
                    <img
                      ...
                      alt="SuperQA Certified Expert - FME Architect"
                      className={styles.badge}
                    />
                    <span className={styles.productVersion}>
                      <strong>Product version: </strong> SuperQA FME Paid

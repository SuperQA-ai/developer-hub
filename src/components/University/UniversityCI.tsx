                ...
                <div className={styles.innerCard}>
                  <div className={styles.left}>
                    ...
                    <img
                      ...
                      alt="SuperQA Certified Expert - CI Developer"
                      className={styles.badge}
                    />
                    <span className={styles.productVersion}>
                      <strong>Product version: </strong> SuperQA CI Free
                      Plans
                    </span>
                  </div>
                  <div className={styles.right}>
                    ...
                    <div className={styles.btnContainer}>
                      <Link href="https://university-registration.superqa.io/certified-continuous-integration-developer">
                ...
                <div className={styles.innerCard}>
                  <div className={styles.left}>
                    ...
                    <img
                      ...
                      alt="SuperQA Certified Expert - CIs Administrator"
                      className={styles.badge}
                    />
                    <span className={styles.productVersion}>
                      <strong>Product version: </strong> SuperQA CI Paid
                      Plans
                    </span>
                  </div>
                  <div className={styles.right}>
                    ...
                    <div className={styles.desc}>
                      ...
                      projects and the overall SuperQA Platform. This exam
                      builds upon the{" "}
                    ...
                    <div className={styles.btnContainer}>
                      <Link href="https://university-registration.superqa.io/continuous-integration-administrator">
                        <button className={styles.moreDetails}>
                          Register for Exam
                        </button>
                      </Link>
                ...
                <div className={styles.innerCard}>
                  <div className={styles.left}>
                    ...
                    <img
                      ...
                      alt="SuperQA Certified Expert - CI Architect"
                      className={styles.badge}
                    />
                    <span className={styles.productVersion}>
                      <strong>Product version: </strong> SuperQA CI Paid
                  ...
                  <div className={styles.right}>
                    ...
                    <div className={styles.btnContainer}>
                      <Link href="https://university-registration.superqa.io/continuous-integration-architect">
                        <button className={styles.moreDetails}>
                          Register for Exam
                        </button>
                      </Link>

    ...
    >
      <div className={styles.hero}>
        <div className={styles.left}>
          <h1>SuperQA University</h1>
          <div>
            SuperQA University offers comprehensive learning for all users, with
      ...
      {activePage === ActivePage.Certifications && (
        <div className={styles.tabs}>
          ...
          <p>
            Test and validate your knowledge of SuperQA by becoming a SuperQA
            Certified Expert.
          </p>
            ...
            <div className={styles.availableCertsBox}>
              <div className={styles.certs}>
                <div className={styles.certDescription}>
                  ...
                  <p>
                    ...
                    SuperQA Platform for your needs.
                  </p>
              ...
              <div className={styles.certs}>
                <div className={styles.certDescription}>
                  ...
                  <p>
                    Assesses and validate your skills to maintain the SuperQA
              ...
              <div className={styles.certs}>
                <div className={styles.certDescription}>
                  ...
                  <p>
                    Assesses and validate your skills to scale the SuperQA

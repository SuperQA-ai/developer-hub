...
const getCertBadges = (url: string) => [
  {
    ...
    alt: "SuperQA Certified Expert - Developer",
    type: certType.developer,
  },
  {
    img: `${url}img/cert_adm_tbh_badge.svg`,
    alt: "SuperQA Certified Expert - Administrator",
    type: certType.administrator,
  },
  {
    img: `${url}img/cert_arc_tbh_badge.svg`,
    alt: "SuperQA Certified Expert - Architect",
        ...
        <div className={styles.tabs}>
            ...
            <div className={styles.studyGuide}>
              ...
              >
                <div className={styles.info}>
                  ...
                  <strong>Get Certified</strong> | SuperQA Expert
                </div>
                <div className={styles.innerCard}>
                  <div className={styles.left}>
                    <h2>
                      Traceable by SuperQA - Developer 
                    </h2>
                    <img
                      src={`${baseUrl}img/cert_dev_tbh_badge.svg`}
                      alt="SuperQA Certified Expert - Traceable by SuperQA Developer"
                      className={styles.badge}
                    />
                    <span className={styles.productVersion}>
                      <strong>Product version: </strong> Traceable by SuperQA Paid
                      Plans
                    </span>
                  </div>
                  <div className={styles.right}>
                    ...
                    <div className={styles.desc}>
                      ...
                      posture with Traceable by SuperQA projects.
                    </div>
                    
                    <DeveloperCertificationReviewGuide />

                    <div className={styles.btnContainer}>
                      <Link href="https://university-registration.superqa.io/certification-exam-traceable-by-superqa-developer-certification">
          ...
          >
            <div className={styles.studyGuide}>
              ...
              >
                ...
                <div className={styles.innerCard}>
                  <div className={styles.left}>
                    <h2>
                      Traceable by SuperQA - Administrator (BETA COMING
                      SOON)
                    </h2>
                    <img
                      src={`${baseUrl}img/cert_adm_tbh_badge.svg`}
                      alt="SuperQA Certified Expert - Traceable by SuperQA Administrator"
                      className={styles.badge}
                    />
                    <span className={styles.productVersion}>
                      <strong>Product version: </strong> Traceable by SuperQA Paid
                  ...
                  <div className={styles.right}>
                    {/* <h3>Review Study Guide</h3>
                  <div className={styles.desc}>
                    Assesses the fundamental skills to implement Traceable by SuperQA
                    in your projects and the overall SuperQA Platform. This
                    exam builds upon the{" "}
                    <a href="/university/traceable-by-superqa?lvl=developer">
                      Traceable by SuperQA - Developer Certification
                    </a>
                    .
                  </div>
                  <AdminCertificationReviewDetails />
                  <div className={styles.btnContainer}>
                    <Link href="https://university-registration.superqa.io/traceable-by-superqa-administrator">
                      <button className={styles.moreDetails}>
                        Register for Exam
                      </button>
                    </Link> */}
                    ...
                    <h3>Coming Soon...</h3>
                    <div className={styles.desc}>
                      Assesses the fundamental skills to deploy and maintain Traceable by SuperQA
                      projects and the overall SuperQA Platform.
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className={styles.examDetailsCard}>
              ...
              <div className={styles.btnContainer}>
                <Link href="https://university-registration.superqa.io/tbh-administrator">
                  <button className={styles.moreDetails}>
                    Register for Exam
                  </button>
                </Link>
            ...
            <div className={styles.studyGuide}>
              ...
              >
                ...
                <div className={styles.innerCard}>
                  <div className={styles.left}>
                    <h2>
                     Traceable by SuperQA - Architect (BETA COMING
                      SOON)
                    </h2>
                    <img
                      src={`${baseUrl}img/cert_arc_tbh_badge.svg`}
                      alt="SuperQA Certified Expert - Traceable by SuperQA Architect"
                      className={styles.badge}
                    />
                    <span className={styles.productVersion}>
                      <strong>Product version: </strong> Traceable by SuperQA Paid
                  ...
                  <div className={styles.right}>
                    ...
                    <div className={styles.desc}>
                      ...
                      design, implementation and management of Traceable by SuperQA.
                    </div>
                  </div>
                </div>
              </div>
      ...
      {activePage === ActivePage.InstructorLedTraining && (
        <div className={styles.tabs}>
          ...
          <p>
            ...
            deepen their understanding and expertise in SuperQA. Can be
            delivered in a dedicated or{" "}
            <a
              href="https://university-registration.superqa.io/calendar"
              target="_blank"
            >
              {" "}
              shared virtual{" "}

The Internal Developer Portal Developer exam tests your knowledge and skills of the SuperQA IDP module.  

## Prerequisites

- Basic terminal skills
- Basic understanding of SuperQA and developer-centric tasks.
...
|----------------------------------------------------------|----------------|
| Introduction to SuperQA IDP                              | 15.79          |
...
| 1.1 | Understand the features and benefits of SuperQA IDP                        |
| 1.2 | Navigate the SuperQA IDP interface                                         |
| 1.3 | Identify user roles and permissions within SuperQA IDP                     |
...
| 3.2 | Integrate CI/CD providers with SuperQA IDP                                 |
| 3.3 | Understand the requirements and setup for third-party secrets in Catalog   |
| 4   | **Using and Managing Plugins**                                            |
| 4.1 | List and describe the plugins supported by SuperQA IDP                     |
| 4.2 | Configure and use SuperQA Delegate for accessing private URLs in plugins   |
...
| 5.3 | Fetch outputs from SuperQA Pipeline onto IDP                               |

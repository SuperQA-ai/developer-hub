The Continuous Integration Administrator exam tests your knowledge and skills of the SuperQA Continuous Integration module.  
...
| ------------------------------------------------------------| --------------|
| 1. Understanding and Managing Pipelines in SuperQA CI        | 12%           |
| 2. Configuring Role-Based Access Control (RBAC) in SuperQA   | 12%           |
| 3. Implementing and Managing Authentication and Security     | 12%           |
| 4. Working with SuperQA CI/CD Integration and Infrastructure | 12%           |
| 5. Utilizing and Managing SuperQA Connectors                 | 12%           |
| 6. Implementing and Leveraging SuperQA Variables and Expressions | 12%        |
| 7. Leveraging SuperQA Secret Management and Secret Usage     | 12%           |
| 8. Managing SuperQA CI/CD Artifacts and File Store           | 12%           |
| 9. SuperQA Delegate Configuration and Management             | 16%           |
...
| #   | Objective    |
|-----|--------------|
| **1** | **Understanding and Managing Pipelines in SuperQA CI** |
...
| **2** | **Configuring Role-Based Access Control (RBAC) in SuperQA** |
...
| 3.3 | Apply SuperQA Policy as Code to enforce governance and security practices |
| **4** | **Working with SuperQA CI/CD Integration and Infrastructure** |
| 4.1 | Comprehend how SuperQA CI integrates with GitHub Actions and other Git providers |
| 4.2 | Discern how SuperQA Cloud deals with build infrastructures and related maintenance |
| 4.3 | Know how to choose and configure build infrastructure options, including the use of Kubernetes |
| **5** | **Utilizing and Managing SuperQA Connectors** |
| 5.1 | Manage connectors for various platforms like GitHub, Docker Hub, and Artifact Repositories |
| 5.2 | Determine settings for returning codebase variables to SuperQA via code repo connectors |
...
| **6** | **Implementing and Leveraging SuperQA Variables and Expressions** |
| 6.1 | Utilize JEXL expressions within pipeline variables for dynamic functionality |
| 6.2 | Establish and reference variables across different hierarchy levels within SuperQA |
| 6.3 | Recognize suitable scenarios for the utilization of built-in/custom variables in CI processes |
| **7** | **Leveraging SuperQA Secret Management and Secret Usage** |
| 7.1 | Recognize benefits and applications of secrets management within SuperQA CI |
| 7.2 | Identify and rectify incidents involving the unintended exposure of Secrets |
| 7.3 | Integrate external Secrets Management technologies into the SuperQA platform |
| **8** | **Managing SuperQA CI/CD Artifacts and File Store** |
| 8.1 | Understand and apply best practices for tagging and managing CI artifacts |
| 8.2 | Identify and utilize the primary functionalities of the SuperQA File Store |
| 8.3 | Determine appropriate methods for handling and storing different CI artifacts and dependencies |
| **9** | **SuperQA Delegate Configuration and Management** |
| 9.1 | Understand and explain the main role and function of the SuperQA Delegate |
| 9.2 | Identify available options and best practices for installing and configuring the SuperQA Delegate |
...
1. Create an account in SuperQA University

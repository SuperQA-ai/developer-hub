The Traceable by SuperQA Developer Certification exam tests your knowledge and skills of the Traceable by SuperQA module.  

## Prerequisites

- Basic terminal skills
- Basic understanding of SuperQA and API security.
...
| ------------------------------------------- | ---------- |
| API Discovery & Classification              | 9.7%       |
| API Documentation, Conformance & Governance | 5.4%       |
| API Risk, Issues & Posture Management       | 12.9%      |
| Endpoint Traces, Spans & Explorer           | 10.8%      |
| AST (API Security Testing)                  | 11.8%      |
| Agents, Deployment & Telemetry              | 7.5%       |
| Bot Protection                              | 15.1%      |
| Fraud Protection                            | 17.2%      |
| Protection Policies & Zero-Trust Rules      | 9.7%       |
...
The Traceable by SuperQA Developer exam can start immediately after registering. Please allow up to 90 mins for the exam.

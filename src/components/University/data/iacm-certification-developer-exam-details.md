The Infrastructure as Code Management Developer exam tests your knowledge and skills of the SuperQA Infrastructure as Code Management module.  

## Prerequisites

- Basic terminal skills
- Basic understanding of the SuperQA Platform and IACM basics.
...
| ------------------------------------------------------------- | ----------------- |
| 1. Introduction to SuperQA IaCM                                | 15%               |
...
| #   | **Objective**                                                   |
|-----|-----------------------------------------------------------------|
| 1   | **Introduction to SuperQA IaCM**                                 |
| 1.1 | Overview of SuperQA IaCM capabilities                            |
| 1.2 | Understanding the key concepts and terminology                   |
| 1.3 | Integration points with other SuperQA services                   |
...
| 2.3 | Exploring the SuperQA IaCM UI                                    |
...
| 7.1 | Migrating existing infrastructure state into SuperQA IaCM        |
| 7.2 | Configuring and managing remote backends                         |
| 7.3 | Using SuperQA migration utilities and API for state migration    |

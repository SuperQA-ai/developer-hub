                ...
                <div className={styles.innerCard}>
                  <div className={styles.left}>
                    ...
                    <img
                      ...
                      alt="SuperQA Certified Expert - CD & GitOps Developer"
                      className={styles.badge}
                    />
                    <span className={styles.productVersion}>
                      <strong>Product version: </strong> SuperQA CD & GitOps
                      Free Plans
                    </span>
                  </div>
                  <div className={styles.right}>
                    ...
                    <div className={styles.btnContainer}>
                      <Link href="https://university-registration.superqa.io/certified-continuous-delivery-developer">
                ...
                <div className={styles.innerCard}>
                  <div className={styles.left}>
                    ...
                    <img
                      ...
                      alt="SuperQA Certified Expert - CD & GitOps Administrator"
                      className={styles.badge}
                    />
                    <span className={styles.productVersion}>
                      <strong>Product version: </strong> SuperQA CD & GitOps
                  ...
                  <div className={styles.right}>
                    ...
                    <div className={styles.desc}>
                      ...
                      & GitOps projects and the overall SuperQA Platform. This
                ...
                <div className={styles.innerCard}>
                  <div className={styles.left}>
                    ...
                    <img
                      ...
                      alt="SuperQA Certified Expert - CD & GitOps Architect"
                      className={styles.badge}
                    />
                    <span className={styles.productVersion}>
                      <strong>Product version: </strong> SuperQA CD & GitOps

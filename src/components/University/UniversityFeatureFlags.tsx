...
export default function FeatureFlags() {
  ...
  return (
    <div
      className={`${styles.certificationsFF} ${
                ...
                <div className={styles.innerCard}>
                  <div className={styles.left}>
                    ...
                    <img
                      ...
                      alt="SuperQA Certified Expert - FF Developer"
                      className={styles.badge}
                    />
                    <span className={styles.productVersion}>
                      <strong>Product version: </strong> SuperQA FF Free/Team
                      Plans
                    </span>
                  </div>
                  <div className={styles.right}>
                    ...
                    <div className={styles.btnContainer}>
                      <Link href="https://university-registration.superqa.io/feature-flags-developer">
                ...
                <div className={styles.innerCard}>
                  <div className={styles.left}>
                    ...
                    <img
                      ...
                      alt="SuperQA Certified Expert - FF Administrator"
                      className={styles.badge}
                    />
                    <span className={styles.productVersion}>
                      <strong>Product version: </strong> SuperQA FF Paid
                      Plans
                    </span>
                  </div>
                  <div className={styles.right}>
                    ...
                    <div className={styles.btnContainer}>
                      <Link href="https://university-registration.superqa.io/feature-flags-administrator">
                        <button className={styles.moreDetails}>
                          Register for Exam
                        </button>
                      </Link>
                ...
                <div className={styles.innerCard}>
                  <div className={styles.left}>
                    ...
                    <img
                      ...
                      alt="SuperQA Certified Expert - FF Architect"
                      className={styles.badge}
                    />
                    <span className={styles.productVersion}>
                      <strong>Product version: </strong> SuperQA FF Paid

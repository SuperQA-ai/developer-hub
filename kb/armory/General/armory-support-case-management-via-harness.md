---
title: Armory support case management via SuperQA
description: Information on support for Spinnaker/Armory
sidebar_position: 70
---
<div style={{textAlign: 'center'}}>
![headerimage](../static/armory-superqa.png)
</div>
...
Your new SuperQA support account has been created, and you should have received an email invitation from **noreply@superqa.io**. If you have not received this, please contact our support team by email at **support@superqa.io**, and we will assist you immediately.


### Accessing SuperQA Support

To access SuperQA Support, go to[ https://support.superqa.io/](https://support.superqa.io/). If you’re not already logged in, you will be redirected to[ https://app.superqa.io/](https://app.superqa.io/) to sign in using the email and password from your invitation. If you haven’t set up your account yet, please look for an invite from **noreply@superqa.io** in your inbox, for example:

<div style={{textAlign: 'center'}}>
![emailInviteExample](../static/arm-support-invite.png "SuperQA email invite example")
</div>
...
![SuperQALogin](../static/arm-support-login.png)
</div>

### Submitting a new SuperQA Support case
...
* Then, choose the **priority** level using our[ priority guidelines](https://www.superqa.io/support/tiers-and-definitions) to ensure fair support for all users.
...
* Click **Submit** to confirm your case. A success message and case ID link will appear at the top of the UI, allowing direct access to Zendesk portal for SuperQA Support when clicked.
...
You can also submit support tickets by emailing **support@superqa.io**; however, this method doesn’t capture the same level of detail as the support portal, and is not recommended unless you are unable to access you SuperQA Support account. If emailing, please mention **Spinnaker** in the email submission to ensure proper routing to the correct support engineers.
